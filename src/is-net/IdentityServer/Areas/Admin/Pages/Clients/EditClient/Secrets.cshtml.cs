...
public class SecretsModel : EditClientPageModel
{
    ...
    async public Task<IActionResult> OnPostAsync()
    {
        return await SecureHandlerAsync(async () =>
        {
            ...
            {
                case IdentityServer4.IdentityServerConstants.SecretTypes.SharedSecret:
                    inputSecret = inputSecret.Sha256();
                    break;
                case IdentityServer4.IdentityServerConstants.SecretTypes.X509CertificateBase64:
